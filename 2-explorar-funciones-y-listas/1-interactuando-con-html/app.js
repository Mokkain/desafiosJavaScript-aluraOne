...
/*4. Crea una función que se ejecute cuando se haga clic en el botón "prompt", preguntando 
...
/*5. Crea una función que muestre una alerta con el mensaje: "Yo amo JS" siempre que se
...
/*6. Al hacer clic en el botón "suma", pide 2 números y muestra el resultado de la 
 suma en una alerta. */

 function suma(){
    let numero1 = parseFloat(prompt("Ingresa el primer número: "));
    let numero2 = parseFloat(prompt("Ingresa el segundo número: "));
    let resultado = alert(numero1 + numero2);
 }